...
- **Mouse-allowed transport surfaces** (per the §1 mouse rule and §6.1.2 / §6.1.3 below):
  ...
  - Click the deck header's **Play / Pause / Restart** glyphs to drive Panic Play (§6.1.2) and Casual Play (§6.1.3). Keyboard equivalents in §5.5.
...
|---|---|---|---|
| **Zoomed column, Performance (Timecode) mode** | ≈ 160 px wide | `DubLayout.deckColumnWidth` | Matches Serato Scratch Live's playing-waveform height in its horizontal layout (≈ 110–140 px). Translated into Dub's vertical orientation, the *width* of the strip is the Serato-equivalent dimension. |
| **Zoomed column, Prep mode** | ≈ 280 px wide today, **rotates to horizontal in M10.8** | `DubLayout.deckColumnWidthPrep` | Prep mode is single-deck and has more real estate to spend; the strip is wider while still bounded. M10.8 rotates it 90° into a true horizontal band across the top of the single-deck surface. |
